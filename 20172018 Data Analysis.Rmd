...
First 5 Ventura County funded a total of 659 slots in 2017-2018 (according to the data received from First 5 Ventura County). We have household income for 583 of those preschoolers and household size for 222 of those preschoolers. The following table and graph show the number of preschool slots funded by First 5 Ventura County by preschool name in 2017-2018. There were 170 slots categorized simply as "Preschool", without a specific preschool name included. 
...
distinct_rowstotal %>% 
  ...
  count(preschool_names) %>% 
  kable(caption = "Preschool Slots in 2017-2018", col.names = c("Preschools", "Number of Slots"))

distinct_rowstotal %>% 
  filter(school_year=="2017-2018") %>% 
  count(preschool_names) %>% 
  ggplot(aes(x=preschool_names, y = n)) +
  geom_col() +
...
The first graph visualizes the mean federal poverty level by preschool. The second graph shows a scatterplot of the FPL for each preschool, except those who fall under a generic "preschool" label. The third graph shows a scatterplot of the FPL for the generic "preschool" label.  
...
distinct_rowstotal %>% 
  filter(school_year=="2017-2018") %>% 
  group_by(preschool_names) %>% 
  summarise(meanfpl = mean(fpl, na.rm = T)) %>% 
  ggplot(aes(x = preschool_names, y = meanfpl)) +
  geom_col()+
  coord_flip() +
...
The first graph visualizes the mean California State Median Income Level by preschool. The second graph shows a scatterplot of the California State Median Income Level for each preschool, except those who fall under a generic "preschool" label. The third graph shows a scatterplot of the California State Median Income Level for the generic "preschool" label.  
...
distinct_rowstotal %>% 
  ...
  ggplot(aes(x = preschool_names, y = meancalmed)) +
  geom_col()+
...
distinct_rowstotal %>% 
  ...
  geom_point(position = "jitter")+
  ggtitle("% California Median Income by Preschool 2017-2018") +
